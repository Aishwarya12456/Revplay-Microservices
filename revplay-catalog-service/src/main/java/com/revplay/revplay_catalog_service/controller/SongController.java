...
public class SongController {
    ...
    public ResponseEntity<SongResponseDTO> uploadSong(
        ...
        System.out.println("Uploading song... Authentication: " + authentication);
        ...
        System.out.println("Artist ID from token: " + artistId);
    ...
    @GetMapping("/artist/{artistId}/song-ids")
    public ResponseEntity<List<Long>> getArtistSongIds(@PathVariable Long artistId) {
        return ResponseEntity.ok(songService.getArtistSongIds(artistId));
    }
