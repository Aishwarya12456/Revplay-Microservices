...
public class AlbumService {
    ...
    public AlbumService(AlbumRepository albumRepository, SongRepository songRepository, CloudinaryService cloudinaryService, SongTransformer songTransformer, UserClient userClient) {
    ...
    public AlbumResponse createAlbum(CreateAlbumRequest request, MultipartFile cover, Long artistId) {
        ...
        List<Song> songs = songRepository.findByAlbumId(savedAlbum.getId());
    ...
    public AlbumResponse updateAlbum(Long albumId, UpdateAlbumRequest request, MultipartFile cover, Long artistId) {
        ...
        if (cover != null && !cover.isEmpty()) {
            String coverImageUrl = cloudinaryService.uploadFile(cover, "revplay/covers");
