    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/revplay/auth/register/**").permitAll()
                        .requestMatchers("/revplay/auth/login").permitAll()
                        ...
                        .requestMatchers("/revplay/auth/user/**").hasAnyRole("LISTENER", "ARTIST")
